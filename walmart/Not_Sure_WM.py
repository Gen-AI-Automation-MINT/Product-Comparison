            ...
            if len(titlepaper) != 0:
                ...
                if len(titlepaper) != 0:
                    ...
                    if len(titlepaper) != 0:
                        ...
                        titlepaper = titlepapercls.find_all(string=re.compile('.*{0}.*'.format(searched_word_format4)),
                                                            recursive=True)
                        if len(titlepaper) != 0:
                            titleformat = "Blu-Ray"
                        else:
                            searched_word_format11 = 'Bd'
                            titlepaper = titlepapercls.find_all(
                                string=re.compile('.*{0}.*'.format(searched_word_format11)), recursive=True)
                            if len(titlepaper) != 0:
                                titleformat = "Blu-Ray"
                            else:
                                searched_word_format11 = 'BD'
                                ...
                                if len(titlepaper) != 0:
                                    ...
                                    if len(titlepaper) != 0:
                                        ...
                                        if len(titlepaper) != 0:
                                            ...
                                            searched_word_format6 = '4K Ultra HD'
                                            titlepaper = titlepapercls.find_all(
                                                string=re.compile('.*{0}.*'.format(searched_word_format6)),
                                                recursive=True)
                                            if len(titlepaper) != 0:
...
def electronics(soup):
    ...
    try:
        prodet = soup.find_all('div', class_='dangerous-html mb3')
        for i in prodet:
            i = i.text.replace(": ", ':').replace("x ", "x").replace(" x", "x").replace(", ", ",").replace("approx. ",
                                                                                                           "").replace(
                "Chart:", "").replace("Package Contents:", "PackageContents:").replace("Working Voltage",
                                                                                       "WorkingVoltage").replace(
                "Supply Voltage", "SupplyVoltage").replace("Input voltage", "Inputvoltage").replace("Operating system",
                                                                                                    "Operatingsystem").replace(
                "Color :", "Color:").replace("Resolution: ", "Resolution:").replace("Type: ", "Type:").split(" ")
            count = 0
            for j in i:
                count += 1
                if 'Colour:' in j or 'Color:' in j or 'color:' in j or 'colour:' in j:
                    prodetcolor = j.replace("Colour:", "").replace("color:", "").replace("colour:", "").replace(
                        "Color:", "").strip()
                ...
                if 'WorkingVoltage:' in j or 'SupplyVoltage:' in j or 'Inputvoltage' in j:
                    prodetvolts = j.replace("WorkingVoltage:", "").replace("SupplyVoltage:", "").replace(
                        "Inputvoltage:", "").strip()
...
# Book Match Type
def bookmatchtype(wmspISBN13, wmspISBN10, titleISBN13, titleISBN10, prodetailISBN13, prodetailISBN10, wmspcolor,
                  wmpagecount, prodetformat, titleformat, wmspformat, swatchformat):
    matchtype = ""
    matchtypecomments = ""
    if wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetformat == '' and titleformat == '' and prodetailISBN10 == '' and wmspformat == '' and wmspcolor == '' and wmpagecount == '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing"
    elif titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 != '' and wmspISBN13 != '' and wmspISBN10 != '' and prodetailISBN10 != '' and (
            prodetailISBN13 != wmspISBN13) and (prodetailISBN10 != wmspISBN10):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif titleISBN13 != '' and titleISBN10 != '' and prodetailISBN13 != '' and wmspISBN13 != '' and wmspISBN10 != '' and prodetailISBN10 != '' and (
            titleISBN13 != prodetailISBN13) and (titleISBN10 != prodetailISBN10) and (
            prodetailISBN13 == wmspISBN13) and (prodetailISBN10 == wmspISBN10):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif titleISBN13 != '' and titleISBN10 != '' and prodetailISBN13 != '' and wmspISBN13 != '' and wmspISBN10 != '' and prodetailISBN10 != '' and (
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif titleformat == '' and swatchformat == '' and prodetformat != '' and wmspformat != '' and (
            prodetformat != wmspformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif titleformat != '' and swatchformat != '' and prodetformat != '' and wmspformat != '' and (
            titleformat != swatchformat) and (prodetformat != wmspformat) and wmpagecount != '':
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif titleformat != '' and swatchformat != '' and prodetformat != '' and wmspformat != '' and (
            titleformat != prodetformat) and (swatchformat != wmspformat) and wmpagecount != '':
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
...
def moviesandmusicmatchtype(wmperformer, wmactors, wmdirector, wmspformat, prodetformat, titleformat, wmpmediaformat):
    ...
    # 3
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and (
            wmspformat != '' and wmspformat != '4K Ultra HD') and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and (
            prodetformat != '' and prodetformat != '4K Ultra HD') and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat == '' and (
            titleformat != '' and titleformat != '4K Ultra HD') and wmpmediaformat == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat == '' and titleformat == '' and (
            wmpmediaformat != '' and wmpmediaformat != '4K Ultra HD'):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"

    # 3
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat == '' and (
            wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD') and (wmspformat == prodetformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat == '' and (
            wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat == titleformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat == '' and titleformat == '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (wmspformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and (
            prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (prodetformat == titleformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (
            prodetformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (prodetformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (
            titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (titleformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    ...
    # 4
            ...
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and (
            wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (
            wmspformat == prodetformat) and (wmspformat == titleformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (
            prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (
            prodetformat == titleformat) and (prodetformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (
            wmspformat == titleformat) and (wmspformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (
            prodetformat == wmspformat) and (prodetformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    ...
    # 5
            ...
            wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (
            (wmspformat == titleformat) or (prodetformat == titleformat) or (prodetformat == wmpmediaformat)):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"

    # 6
    elif (
            wmperformer != '' or wmactors != '' or wmdirector != '') and wmspformat == '' and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Format"
    ...
    # 12
        ...
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"
    elif wmspformat == '' and prodetformat == '' and (
            titleformat != '' and titleformat == '4K Ultra HD') and wmpmediaformat == '':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"
    elif wmspformat == '' and prodetformat == '' and titleformat != '' and (
            wmpmediaformat != '' and wmpmediaformat == '4K Ultra HD'):
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"
    ...
    # Mutiple 10
    elif wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat == '' and (
            wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD') and (wmspformat != prodetformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat == '' and (
        ...
        matchtypecomments = "Multiple Info"
            ...
            wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD') and (prodetformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat == '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (
            wmpmediaformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    ...
    # 11
            ...
            wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (
            wmspformat != prodetformat) and (wmspformat != titleformat) and (prodetformat != titleformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (
            wmspformat != prodetformat) and (wmspformat != wmpmediaformat) and (prodetformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (
            wmspformat != titleformat) and (wmspformat != wmpmediaformat) and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (
            wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (
            prodetformat != titleformat) and (prodetformat != wmpmediaformat) and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    ...
    # 12
            ...
            wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (
            wmspformat != prodetformat) and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (
            wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (
            wmspformat != titleformat) and (prodetformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
...
def autotiresmatchtype(wmspmodel, wmsppartno, wmtiresize, prodettiresize, prodetloadrange, titletiresize,
                       titleloadrange, wmtirespeedrating):
    matchtype = ""
    matchtypecomments = ""
    ...
    # 2
    if (
            wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize == '' and titletiresize == '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating != '':
        matchtype = "Not Sure"
    ...
    if (
            wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize == '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating != '' and (
            prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size"
    ...
    # 7
            ...
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
            wmtiresize == prodettiresize):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif (
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
            wmtiresize == titletiresize):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif (
            wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
            prodettiresize == titletiresize):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    ...
    # 8
            ...
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
            (wmtiresize == titletiresize) or (wmtiresize == prodettiresize) or (titletiresize == prodettiresize)):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    ...
    # 7
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
            wmtiresize == prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
    ...
    # 16
            ...
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (
            wmtiresize == prodettiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    elif (
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (
            wmtiresize == titletiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    elif (
            wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (
            prodettiresize == titletiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    ...
    # 17
            ...
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (
            (wmtiresize == titletiresize) or (wmtiresize == prodettiresize) or (titletiresize == prodettiresize)) and (
            prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    ...
    # 22
            ...
            wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (
            wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (titletiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    ...
    # 25
    elif wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating == '' and (
            wmtiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating == '' and (
    ...
    # 29
            ...
            wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (titletiresize != prodettiresize) and (
            prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    ...
    # 23
    elif wmspmodel != '' and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange == '' and wmtirespeedrating != '' and (
            wmtiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspmodel != '' and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange != '' and titleloadrange == '' and wmtirespeedrating != '' and (
    ...
    # 26
            ...
            wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (prodettiresize != titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    ...
    # 29
            ...
            wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (prodettiresize != titletiresize) and (
            prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
...
def videogamesmatchtype(wmvideogameplatform, titleplatform, prodetplatform, breadcrumb):
    ...
    # 2
    if wmvideogameplatform != '' and titleplatform != '' and prodetplatform == '' and (
            wmvideogameplatform != titleplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    if wmvideogameplatform != '' and titleplatform == '' and prodetplatform != '' and (
            wmvideogameplatform != prodetplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    if wmvideogameplatform == '' and titleplatform != '' and prodetplatform != '' and (titleplatform != prodetplatform):
        ...
        matchtypecomments = "Multiple info"
    if wmvideogameplatform != '' and titleplatform != '' and prodetplatform != '' and (
            wmvideogameplatform != titleplatform) and (wmvideogameplatform != prodetplatform) and (
            titleplatform != prodetplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
...
def electronicsaudiomatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor, prodetsize, swatchsize, wmspsize,
                              wmspmodel):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '':
    ...
    elif wmspcolor != '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and (
            wmspcolor != prodetcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor == '' and swatchcolor != '' and titlecolor == '' and (
            wmspcolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
        ...
        matchtypecomments = "Multiple info"
            ...
            prodetcolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor != '' and swatchcolor == '' and titlecolor != '' and (
            prodetcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor != '' and titlecolor != '' and (
        ...
        matchtypecomments = "Multiple info"
            ...
            wmspcolor != prodetcolor) and (wmspcolor != swatchcolor) and (prodetcolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor != '' and swatchcolor == '' and titlecolor != '' and (
            wmspcolor != prodetcolor) and (wmspcolor != titlecolor) and (prodetcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor != '' and swatchcolor != '' and titlecolor != '' and (
            prodetcolor != swatchcolor) and (swatchcolor != titlecolor) and (prodetcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor == '' and swatchcolor != '' and titlecolor != '' and (
            wmspcolor != swatchcolor) and (wmspcolor != titlecolor) and (swatchcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"

    elif wmspcolor != '' and prodetcolor != '' and swatchcolor != '' and titlecolor != '' and (
            wmspcolor != prodetcolor) and (wmspcolor != swatchcolor) and (wmspcolor != titlecolor) and (
            prodetcolor != swatchcolor) and (prodetcolor != titlecolor) and (swatchcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif prodetsize != '' and swatchsize != '' and wmspsize != '' and (prodetsize != swatchsize) and (
            prodetsize != wmspsize) and (swatchsize != wmspsize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
...
def electronicscomputersmatchtype(wmos, prodetos, prodetnetwork, wmspcolor, prodetcolor, swatchcolor, titlecolor,
                                  prodetsize, swatchsize, wmspsize, wmspmodel, wmprocessortype):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
    ...
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Size/Processor Type"
    elif (
            wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Color/Network Type"

    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Network Type"

    elif (
            wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Network Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        ...
        matchtypecomments = "Multiple info"
            ...
            prodetsize != wmspsize) and (wmspsize != swatchsize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
...
def electronicscellphonematchtype(prodetnetwork, wmspcolor, prodetcolor, swatchcolor, titlecolor, prodetsize,
                                  swatchsize, wmspsize, wmspmodel, wmspportno):
    matchtype = ""
    matchtypecomments = ""
    ...
    if prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmsppartno == '':
    ...
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and (
            wmspmodel != '' or wmsppartno != ''):
        matchtype = "Not Sure"
    ...
    elif prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Size/Network"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel == '' and wmsppartno == '':
        matchtype = "Not Sure"
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size"
    elif prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Network"
    elif prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and (
            wmspmodel != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Size"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and (wmspmodel != '' or wmsppartno != ''):
        matchtype = "Not Sure"
...
def electronicswearabletechnologymatchtype(wmos, prodetos, prodetnetwork, wmspcolor, prodetcolor, swatchcolor,
                                           titlecolor, prodetsize, swatchsize, wmspsize, wmspmodel):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '':
        ...
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size/Model"
            ...
            wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Color/Network Type"

    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Network Type"

    elif (
            wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Network Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and (
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (
...
def electronicscameramatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor, prodetsize, swatchsize, wmspsize,
                               prodetresolution):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetresolution == '':
        ...
        matchtypecomments = "Info Missing - Color/Size/Resolution"
            ...
            wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetresolution == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Resolution"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetresolution == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Resolution"
    elif (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (
            prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetresolution == '':
        matchtype = "Not Sure"
...
def electronicsgpsmatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor, prodetsize, swatchsize, wmspsize,
                            prodetvolts, prodetitemtype, wmspmodel):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        ...
        matchtypecomments = "Info Missing - Color/Size/Volts/Type/Model"
            ...
            wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Volts/Type/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (
            prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
...
def electronicstvmatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor, prodetsize, swatchsize, wmspsize, wmspmodel,
                           wmsppartno, wmscreensize):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color/Size"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and (
            wmspmodel != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmsppartno == '':
...
def AttributeExtraction(lines):
    ...
    if pgproblem == '':
        ...
        if ((len(results) == 0) and (len(results1) == 0) and (len(results2) == 0) and (len(results3) == 0) and (
                len(results4) == 0) and (len(results5) == 0) and (len(results6) == 0) and (len(results7) == 0) and (
                len(results8) == 0) and (len(results9) == 0) and (len(results10) == 0)):
            ...
            for bb in bb:
                if bb != None:
                    ...
                    if ((len(results) == 0) and (len(results1) == 0) and (len(results2) == 0) and (
                            len(results3) == 0) and (len(results4) == 0) and (len(results5) == 0) and (
                            len(results6) == 0) and (len(results7) == 0) and (len(results8) == 0) and (
                            len(results9) == 0) and (len(results10) == 0)):
                        pgproblem = ''
                    else:
                ...
                if bb1 == None:
                    ...
                    if bb1 == None:
                        ...
                        if bb1 != None:
                            ...
                            results10 = bb1.find_all(string=re.compile('.*{0}.*'.format(searched_word10)),
                                                     recursive=True)
    ...
    if pgproblem == '' or pgproblem == 'Walmart Exclusive':
        try:
            ...
            if wmtitbrandtag == None:
                wmtitbrandtag = soup.find('a',
                                          class_='bg-transparent bn lh-solid pa0 sans-serif tc underline inline-button mid-gray pointer f6')
        ...
        try:
            ...
            for item in d:
                ...
                for item1 in swatch:
                    ...
                    for it in swatch:
                        dd = it.find_all("label",
                                         class_="bg-white flex dark-gray pointer relative flex-column items-center b")
                        for it1 in dd:
        ...
        if breadcrumbsplit[0] == "Books":
            titleISBN13, titleISBN10, prodetailISBN13, prodetailISBN10, titleformat, prodetformat, wmcondition, dspagecount = book(
                soup)
            ...
            prodettiresize, prodetloadrange, titletiresize, titleloadrange, titlespeedrating = autotires(soup,
                                                                                                         wmtiresize,
                                                                                                         wmfeatures)
        elif breadcrumbsplit[0] == "Video Games":
            prodetplatformlist, titleplatform = videogames(soup)
        elif (breadcrumbsplit[0] == "Electronics" and "Audio" in breadcrumbsplit or breadcrumbsplit[0] == "Audio") or (
                breadcrumbsplit[0] == "Electronics" and "Portable Audio" in breadcrumbsplit) or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Home Audio & Theater") or (
                breadcrumbsplit[0] == "Portable Audio"):
            prodetcolor, swatchcolor, prodetsize, swatchsize, titlepackcount, prodetpackcount, prodetos, prodetvolts, prodetnetwork, titlecolor, prodetresolution, prodetitemtype = electronics(
                soup)
        elif breadcrumbsplit[0] == "Electronics" and "Computers" in breadcrumbsplit or breadcrumbsplit[
            0] == "Computers":
            prodetcolor, swatchcolor, prodetsize, swatchsize, titlepackcount, prodetpackcount, prodetos, prodetvolts, prodetnetwork, titlecolor, prodetresolution, prodetitemtype = electronics(
                soup)
        elif breadcrumbsplit[0] == "Cell Phones" or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Home Theater") or (
                breadcrumbsplit[0] == "Electronics" and "iPad & Tablets" in breadcrumbsplit) or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Video") or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Electronics Accessories"):
            prodetcolor, swatchcolor, prodetsize, swatchsize, titlepackcount, prodetpackcount, prodetos, prodetvolts, prodetnetwork, titlecolor, prodetresolution, prodetitemtype = electronics(
                soup)
        elif breadcrumbsplit[0] == "Electronics" and "Wearable Technology" in breadcrumbsplit:
            prodetcolor, swatchcolor, prodetsize, swatchsize, titlepackcount, prodetpackcount, prodetos, prodetvolts, prodetnetwork, titlecolor, prodetresolution, prodetitemtype = electronics(
                soup)
        elif (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Cameras & Camcorders") or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Drones") or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Surveillance Equipment"):
            prodetcolor, swatchcolor, prodetsize, swatchsize, titlepackcount, prodetpackcount, prodetos, prodetvolts, prodetnetwork, titlecolor, prodetresolution, prodetitemtype = electronics(
                soup)
            ...
            titleISBN13, titleISBN10, prodetailISBN13, prodetailISBN10, titleformat, prodetformat, wmcondition, dspagecount = extraction(
                soup)
        ...
        # Match Type
        if breadcrumbsplit[0] == "Books":
            matchtype, matchtypecomments = bookmatchtype(wmspISBN13, wmspISBN10, titleISBN13, titleISBN10,
                                                         prodetailISBN13, prodetailISBN10, wmspcolor, wmpagecount,
                                                         prodetformat, titleformat, wmspformat, swatchformat)
        elif breadcrumbsplit[0] == "Movies & TV Shows" or breadcrumbsplit[0] == "Music":
            matchtype, matchtypecomments = moviesandmusicmatchtype(wmperformer, wmactors, wmdirector, wmspformat,
                                                                   prodetformat, titleformat, wmpmediaformat)
        elif breadcrumbsplit[0] == "Auto & Tires" and breadcrumbsplit[1] == "Tires & Accessories":
            matchtype, matchtypecomments = autotiresmatchtype(wmspmodel, wmsppartno, wmtiresize, prodettiresize,
                                                              prodetloadrange, titletiresize, titleloadrange,
                                                              wmtirespeedrating)
        elif breadcrumbsplit[0] == "Video Games":
            matchtype, matchtypecomments = videogamesmatchtype(wmvideogameplatform, titleplatform, prodetplatform,
                                                               breadcrumb)
        elif (breadcrumbsplit[0] == "Electronics" and "Audio" in breadcrumbsplit or breadcrumbsplit[0] == "Audio") or (
                breadcrumbsplit[0] == "Electronics" and "Portable Audio" in breadcrumbsplit) or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Home Audio & Theater") or (
                breadcrumbsplit[0] == "Portable Audio"):
            matchtype, matchtypecomments = electronicsaudiomatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor,
                                                                     prodetsize, swatchsize, wmspsize, wmspmodel)
        elif breadcrumbsplit[0] == "Electronics" and "Computers" in breadcrumbsplit or breadcrumbsplit[
            0] == "Computers":
            matchtype, matchtypecomments = electronicscomputersmatchtype(wmos, prodetos, prodetnetwork, wmspcolor,
                                                                         prodetcolor, swatchcolor, titlecolor,
                                                                         prodetsize, swatchsize, wmspsize, wmspmodel,
                                                                         wmprocessortype)
        elif breadcrumbsplit[0] == "Cell Phones" or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Home Theater") or (
                ...
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Video") or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Electronics Accessories"):
            matchtype, matchtypecomments = electronicscellphonematchtype(prodetnetwork, wmspcolor, prodetcolor,
                                                                         swatchcolor, titlecolor, prodetsize,
                                                                         swatchsize, wmspsize, wmspmodel, wmsppartno)
        elif breadcrumbsplit[0] == "Electronics" and "Wearable Technology" in breadcrumbsplit:
            matchtype, matchtypecomments = electronicswearabletechnologymatchtype(wmos, prodetos, prodetnetwork,
                                                                                  wmspcolor, prodetcolor, swatchcolor,
                                                                                  titlecolor, prodetsize, swatchsize,
                                                                                  wmspsize, wmspmodel)
        elif (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Cameras & Camcorders") or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Drones") or (
                breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Surveillance Equipment"):
            matchtype, matchtypecomments = electronicscameramatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor,
                                                                      prodetsize, swatchsize, wmspsize,
                                                                      prodetresolution)
        elif breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "GPS & Navigation":
            matchtype, matchtypecomments = electronicsgpsmatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor,
                                                                   prodetsize, swatchsize, wmspsize, prodetvolts,
                                                                   prodetitemtype, wmspmodel)
        elif breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Home Theater":
            matchtype, matchtypecomments = electronicstvmatchtype(wmspcolor, prodetcolor, swatchcolor, titlecolor,
                                                                  prodetsize, swatchsize, wmspsize, wmspmodel,
                                                                  wmsppartno, wmscreensize)
        elif breadcrumbsplit[0] == "Electronics":
    ...
    for url_lines in cursor.fetchall():
        ...
        cursor.execute(
            ...
            (wmid, tooldate, tooltime, batch_id, url, pgproblem, matchtype, matchtypecomments, itemid, breadcrumb,
             ...
             prodetnetwork, prodetcolor, swatchcolor, titlecolor, prodetsize, swatchsize, prodetresolution,
             prodetitemtype))
        connection.commit()
