...
#Book Match Type
def bookmatchtype(wmspISBN13,wmspISBN10,titleISBN13,titleISBN10,prodetailISBN13,prodetailISBN10,wmspcolor,wmpagecount,prodetformat,titleformat,wmspformat,swatchformat):
        matchtype = ""
        matchtypecomments = ""
        if wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetformat == '' and titleformat == '' and prodetailISBN10 == '' and wmspformat == '' and wmspcolor == '' and wmpagecount == '':
            matchtype = "Not Sure"
            matchtypecomments = "Info Missing"
        elif wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetailISBN10 == '' and prodetformat == '' and titleformat == '' and wmspformat == '' and swatchformat == '' and wmspcolor == '' and wmpagecount != '':
            matchtype = "Not Sure"
            matchtypecomments = "Info Missing"
        elif wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetailISBN10 == '' and prodetformat != '' and titleformat == '' and wmspformat == '' and swatchformat == '' and wmspcolor == '' and wmpagecount == '':
            matchtype = "Not Sure"
            ...
            matchtype = "Not Sure"
            matchtypecomments = "Info Missing"
        elif wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetailISBN10 == '' and prodetformat == '' and titleformat == '' and wmspformat == 'Others' and swatchformat == '' and wmspcolor == '' and wmpagecount == '':
            matchtype = "Not Sure"
            matchtypecomments = "Info Missing"
        elif wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetailISBN10 == '' and prodetformat == '' and titleformat == '' and wmspformat == 'Leather Bound' and swatchformat == '' and wmspcolor == '' and wmpagecount == '':
            matchtype = "Not Sure"
            matchtypecomments = "Info Missing"
        elif wmspISBN13 == '' and wmspISBN10 == '' and titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 == '' and prodetailISBN10 == '' and prodetformat == '' and titleformat == '' and wmspformat == 'Leather Bound' and swatchformat == '' and wmspcolor != '' and wmpagecount == '':
            matchtype = "Not Sure"
            matchtypecomments = "Info Missing"
        elif titleISBN13 == '' and titleISBN10 == '' and prodetailISBN13 != '' and wmspISBN13 != '' and wmspISBN10 != '' and prodetailISBN10 != '' and (prodetailISBN13 != wmspISBN13) and (prodetailISBN10 != wmspISBN10):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple Info"
        elif titleISBN13 != '' and titleISBN10 != '' and prodetailISBN13 != '' and wmspISBN13 != '' and wmspISBN10 != '' and prodetailISBN10 != '' and (titleISBN13 != prodetailISBN13) and (titleISBN10 != prodetailISBN10) and (prodetailISBN13 == wmspISBN13) and (prodetailISBN10 == wmspISBN10):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple Info"
        elif titleISBN13 != '' and titleISBN10 != '' and prodetailISBN13 != '' and wmspISBN13 != '' and wmspISBN10 != '' and prodetailISBN10 != '' and (titleISBN13 == prodetailISBN13) and (titleISBN10 == prodetailISBN10) and (prodetailISBN13 != wmspISBN13) and (prodetailISBN10 != wmspISBN10):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple Info"
        elif titleformat == '' and swatchformat == '' and prodetformat != '' and wmspformat != '' and (prodetformat != wmspformat):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple Info"
        elif titleformat != '' and swatchformat != '' and prodetformat != '' and wmspformat != '' and (titleformat != swatchformat) and (prodetformat != wmspformat) and wmpagecount != '':
            matchtype = "Not Sure"
            matchtypecomments = "Multiple Info"
        elif titleformat != '' and swatchformat != '' and prodetformat != '' and wmspformat != '' and (titleformat != prodetformat) and (swatchformat != wmspformat) and wmpagecount != '':
            matchtype = "Not Sure"
            matchtypecomments = "Multiple Info"
        return matchtype,matchtypecomments

def moviesandmusicmatchtype(wmperformer,wmactors,wmdirector,wmspformat,prodetformat,titleformat,wmpmediaformat):
    matchtype = ""
    matchtypecomments = ""
    if wmspformat.lower() == 'ntsc':
        wmspformat = 'DVD'
    if prodetformat.lower() == 'ntsc':
        prodetformat = 'DVD'
    if titleformat.lower() == 'ntsc':
        titleformat = 'DVD'
    if wmpmediaformat == 'ntsc':
        wmpmediaformat = 'DVD'
    if wmspformat.lower() == 'lp':
        wmspformat = 'Vinyl'
    if prodetformat.lower() == 'lp':
        prodetformat = 'Vinyl'
    if titleformat.lower() == 'lp':
        titleformat = 'Vinyl'
    if wmpmediaformat.lower() == 'lp':
        wmpmediaformat = 'Vinyl'
    if wmspformat.lower() == 'bd':
        wmspformat = 'Blu-Ray'
    if prodetformat.lower() == 'bd':
        prodetformat = 'Blu-Ray'
    if titleformat.lower() == 'bd':
        titleformat = 'Blu-Ray'
    if wmpmediaformat.lower() == 'bd':
        wmpmediaformat = 'Blu-Ray'
    
    #1
    if wmperformer == '' and wmactors == '' and wmdirector == '' and wmspformat == '' and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer/Format"
    
    #2
    elif wmspformat == '' and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Format"
    
    #3
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and (wmspformat != '' and wmspformat != '4K Ultra HD') and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and (prodetformat != '' and prodetformat != '4K Ultra HD') and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat == '' and (titleformat != '' and titleformat != '4K Ultra HD') and wmpmediaformat == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat == '' and titleformat == '' and (wmpmediaformat != '' and wmpmediaformat != '4K Ultra HD'):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"

    #3
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat == '' and (wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD') and (wmspformat == prodetformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat == '' and (wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat == titleformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"    
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat == '' and titleformat == '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (wmspformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"   
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and (prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (prodetformat == titleformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (prodetformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (prodetformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (titleformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"

    #4
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and (wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat == prodetformat) and (wmspformat == titleformat):    
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (prodetformat == titleformat) and (prodetformat == wmpmediaformat) :
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (wmspformat == titleformat) and (wmspformat == wmpmediaformat) :
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (prodetformat == wmspformat) and (prodetformat == wmpmediaformat):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"

    #5
    elif (wmperformer == '' and wmactors == '' and wmdirector == '') and wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and ((wmspformat == titleformat) or (prodetformat == titleformat) or (prodetformat == wmpmediaformat)):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Performer/Artist/Actor/Director/Singer"

    #6
    elif (wmperformer != '' or wmactors != '' or wmdirector != '') and wmspformat == '' and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Format"

	
    #12
    elif (wmspformat != '' and wmspformat == '4K Ultra HD') and prodetformat == '' and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"
    elif wmspformat == ''  and (prodetformat != '' and prodetformat == '4K Ultra HD')  and titleformat == '' and wmpmediaformat == '':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"
    elif wmspformat == ''  and prodetformat == '' and (titleformat != '' and titleformat == '4K Ultra HD') and wmpmediaformat == '':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"
    elif wmspformat == ''  and prodetformat == '' and titleformat != '' and (wmpmediaformat != '' and wmpmediaformat == '4K Ultra HD'):
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4k Format"

    #13
    elif wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat == '' and wmspformat == '4K Ultra HD' and prodetformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat == '' and wmspformat == '4K Ultra HD' and titleformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat != '' and prodetformat == '' and titleformat == '' and wmpmediaformat != '' and wmspformat == '4K Ultra HD' and wmpmediaformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and prodetformat == '4K Ultra HD' and titleformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat == '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and wmpmediaformat == '4K Ultra HD' and prodetformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat == '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and wmpmediaformat == '4K Ultra HD' and wmpmediaformat != '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"

    #14   
    elif wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and wmspformat == '4K Ultra HD' and prodetformat == '4K Ultra HD' and titleformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and wmspformat == '4K Ultra HD' and prodetformat == '4K Ultra HD' and wmpmediaformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    elif wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and wmspformat == '4K Ultra HD' and titleformat == '4K Ultra HD' and wmpmediaformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format" 
    elif wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and wmpmediaformat == '4K Ultra HD' and prodetformat == '4K Ultra HD' and titleformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"
    
    #15
    elif wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and wmpmediaformat == '4K Ultra HD' and prodetformat == '4K Ultra HD' and titleformat == '4K Ultra HD' and wmspformat == '4K Ultra HD':
        matchtype = "Not Sure - Low Confidence"
        matchtypecomments = "4K Format"

	#Mutiple 10
    elif wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat == '' and (wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD') and (wmspformat != prodetformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat == '' and (wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat != titleformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat == '' and titleformat == '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (wmspformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and (prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (prodetformat != titleformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat == '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD') and (prodetformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat == '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (wmpmediaformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"

    #11
    elif wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat == '' and (wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat != prodetformat) and (wmspformat != titleformat) and (prodetformat != titleformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat != '' and titleformat == '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (wmspformat != prodetformat) and (wmspformat != wmpmediaformat) and (prodetformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat == '' and titleformat != '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and titleformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD') and (wmspformat != titleformat) and (wmspformat != wmpmediaformat) and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info" 
    elif wmspformat == '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (prodetformat != titleformat) and (prodetformat != wmpmediaformat) and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    
    #12
    elif wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat != prodetformat) and (titleformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"
    elif wmspformat != '' and prodetformat != '' and titleformat != '' and wmpmediaformat != '' and (wmspformat != '4K Ultra HD' and wmpmediaformat != '4K Ultra HD' and prodetformat != '4K Ultra HD' and titleformat != '4K Ultra HD') and (wmspformat != titleformat) and (prodetformat != wmpmediaformat):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple Info"

    return matchtype,matchtypecomments
           
def autotiresmatchtype(wmspmodel,wmsppartno,wmtiresize,prodettiresize,prodetloadrange,titletiresize,titleloadrange,wmtirespeedrating):
    matchtype = ""
    matchtypecomments = ""
    ...
    if len(wmsppartno) >= 3:
        ...
        wmsppartno = ''
    #1
    if wmspmodel == '' and wmsppartno == '' and wmtiresize == '' and prodettiresize == '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Size/Load Range/Speed Rating"
    
    #2
    if (wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize == '' and titletiresize == '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating != '':
        matchtype = "Not Sure"
    ...
    if (wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize == '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating != '' and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size"
    ...
    #6
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize == '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '':
        matchtype = "Not Sure - Low confidence"
    ...
    #7
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (wmtiresize == prodettiresize):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif(wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (wmtiresize == titletiresize):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (prodettiresize == titletiresize):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"

    #8
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and ((wmtiresize == titletiresize) or (wmtiresize == prodettiresize) or (titletiresize == prodettiresize)):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    
    #6
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize == '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize == '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '':
        matchtype = "Not Sure"
    ...
    #7
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (wmtiresize == prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (wmtiresize == titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (prodettiresize == titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"

    #8
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and ((wmtiresize == titletiresize) or (wmtiresize == prodettiresize) or (titletiresize == prodettiresize)):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Load Range/Speed Rating"
    ...
    #15
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize == '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
    ...
    #16
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize == prodettiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize == titletiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodettiresize == titletiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    
    #17
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and ((wmtiresize == titletiresize) or (wmtiresize == prodettiresize) or (titletiresize == prodettiresize)) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Speed Rating"
    ...
    #15
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize == '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize == '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
    ...
    #16
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize == prodettiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize == titletiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Speed Rating"
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodettiresize == titletiresize) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Speed Rating"
    
    #17
    elif wmspmodel == '' and wmsppartno == '' and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and ((wmtiresize == titletiresize) or (wmtiresize == prodettiresize) or (titletiresize == prodettiresize)) and (prodetloadrange == titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Speed Rating"
    ...
    #22
    elif (wmspmodel != '' or wmsppartno != '') and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange == '' and wmtirespeedrating == '' and (wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (titletiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    ...
    #25
    elif wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize != titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating == '' and (prodettiresize != titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    
    #26
    elif wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (titletiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"

    #27
    elif wmtiresize != '' and prodettiresize == '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmtiresize == '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
    ...
    #28
    elif wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize != prodettiresize) and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize != titletiresize) and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (prodettiresize != titletiresize) and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    
    #29
    elif wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating == '' and (wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (titletiresize != prodettiresize) and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"

    #speedrating multiinfo
    #23
    elif wmspmodel != '' and wmtiresize != '' and prodettiresize != '' and titletiresize == '' and prodetloadrange != '' and titleloadrange == '' and wmtirespeedrating != '' and (wmtiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspmodel != '' and wmtiresize != '' and prodettiresize == '' and titletiresize != '' and prodetloadrange != '' and titleloadrange == '' and wmtirespeedrating != '' and (wmtiresize != titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspmodel != '' and wmtiresize == '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange == '' and wmtirespeedrating != '' and (prodettiresize != titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    
    #24
    elif wmspmodel != '' and wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange == '' and wmtirespeedrating != '' and (wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (titletiresize != prodettiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    ...
    #26
    elif wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange == '' and titleloadrange != '' and wmtirespeedrating != '' and (wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (prodettiresize != titletiresize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
 ...
 #27
    ...
    #29
    elif wmtiresize != '' and prodettiresize != '' and titletiresize != '' and prodetloadrange != '' and titleloadrange != '' and wmtirespeedrating != '' and (wmtiresize != titletiresize) and (wmtiresize != prodettiresize) and (prodettiresize != titletiresize) and (prodetloadrange != titleloadrange):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
...
def videogamesmatchtype(wmvideogameplatform,titleplatform,prodetplatform,breadcrumb):
    matchtype = ""
    matchtypecomments = ""
    wmvideogameplatform = wmvideogameplatform.replace("microsoft","").lower().strip()
    
    bvalue = ""
    if 'Accessories' in breadcrumb:
        bvalue = "Yes"
    
    #1
    if wmvideogameplatform == '' and titleplatform == '' and prodetplatform == '' and bvalue == 'Yes':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Platform"

    #2
    if wmvideogameplatform != '' and titleplatform != '' and prodetplatform == '' and (wmvideogameplatform != titleplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    if wmvideogameplatform != '' and titleplatform == '' and prodetplatform != '' and (wmvideogameplatform != prodetplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    if wmvideogameplatform == '' and titleplatform != '' and prodetplatform != '' and (titleplatform != prodetplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    if wmvideogameplatform != '' and titleplatform != '' and prodetplatform != '' and (wmvideogameplatform != titleplatform) and (wmvideogameplatform != prodetplatform) and (titleplatform != prodetplatform):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
...
def electronicsmatchtype(wmos,prodetos,prodetvolts,prodetnetwork):
    matchtype = ""
    matchtypecomments = ""

    #1
    if wmos == '' and prodetos == '' and prodetvolts == '' and prodetnetwork == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing"
    
    #2
    elif wmos != '' and prodetos != '' and prodetvolts == '' and prodetnetwork == '' and (wmos == prodetos):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Watts/Volts/Amps/Lumens/MAH/Networktype"
    elif wmos != '' and prodetos != '' and prodetvolts != '' and prodetnetwork == '' and (wmos == prodetos):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Networktype"
    elif wmos != '' and prodetos != '' and prodetvolts == '' and prodetnetwork != '' and (wmos == prodetos):
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Watts/Volts/Amps/Lumens/MAH"
...
def electronicsaudiomatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel):
    matchtype = ""
    matchtypecomments = ""
    
    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel  == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Model"
    elif prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and wmspmodel != '':
        matchtype = "Not Sure"
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model"
    elif wmspcolor != '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel  == '':
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Size/Model"
    elif wmspcolor == '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel  == '':
        matchtype = "Not Sure - Low confidence"
        ...
        matchtype = "Not Sure - Low confidence"
        matchtypecomments = "Info Missing - Color/Size"

    elif wmspcolor != '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and (wmspcolor != prodetcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor == '' and swatchcolor != '' and titlecolor == '' and (wmspcolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor == '' and swatchcolor == '' and titlecolor != '' and (wmspcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor != '' and swatchcolor != '' and titlecolor == '' and (prodetcolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor != '' and swatchcolor == '' and titlecolor != '' and (prodetcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor != '' and titlecolor != '' and (titlecolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"

    elif wmspcolor != '' and prodetcolor != '' and swatchcolor != '' and titlecolor == '' and (wmspcolor != prodetcolor) and (wmspcolor != swatchcolor) and (prodetcolor != swatchcolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor != '' and swatchcolor == '' and titlecolor != '' and (wmspcolor != prodetcolor) and (wmspcolor != titlecolor) and (prodetcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor != '' and swatchcolor != '' and titlecolor != '' and (prodetcolor != swatchcolor) and (swatchcolor != titlecolor) and (prodetcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor == '' and swatchcolor != '' and titlecolor != '' and (wmspcolor != swatchcolor) and (wmspcolor != titlecolor) and (swatchcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    
    elif wmspcolor != '' and prodetcolor != '' and swatchcolor != '' and titlecolor != '' and (wmspcolor != prodetcolor) and (wmspcolor != swatchcolor) and (wmspcolor != titlecolor) and (prodetcolor != swatchcolor) and (prodetcolor != titlecolor) and (swatchcolor != titlecolor):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    
    elif prodetsize != '' and swatchsize != '' and wmspsize == '' and (prodetsize != swatchsize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif prodetsize != '' and swatchsize == '' and wmspsize != '' and (prodetsize != wmspsize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif prodetsize == '' and swatchsize != '' and wmspsize != '' and (swatchsize != wmspsize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif prodetsize != '' and swatchsize != '' and wmspsize != '' and (prodetsize != swatchsize) and (prodetsize != wmspsize) and (swatchsize != wmspsize):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    
    return matchtype,matchtypecomments
    
def electronicscomputersmatchtype(wmos,prodetos,prodetnetwork,wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel,wmprocessortype):
    matchtype = ""
    matchtypecomments = ""

    if wmos != '' and prodetos != '' and wmos in prodetos:
        prodetos = wmos
    
    if wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size/Model/Processor Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Size/Processor Type"
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Color/Network Type"
    
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Network Type"
        
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Network Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type"
    
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel == '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Model"
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Processor Type"
    
        
    elif wmos != '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Color/Size/Model/Processor Type"
    elif wmos == '' and prodetos != '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Color/Size/Model/Processor Type"
    elif wmos != '' and prodetos != '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Color/Size/Model/Processor Type"


    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor != '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Size/Model/Processor Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Size/Model/Processor Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor != '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Model/Processor Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == ''  and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize != '' and wmspsize == '' and wmspmodel == '' and wmprocessortype == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Model/Processor Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == ''  and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize != '' and wmspmodel == '' and wmprocessortype == '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size/Processor Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == ''  and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' and wmprocessortype != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size/Model"
    elif wmos != '' and prodetos != '' and (wmos != prodetos):
        matchtype = "Not Sure"
        matchtypecomments = "Multiple info"
    elif wmspcolor != '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and (wmspcolor != prodetcolor):
            matchtype = "Not Sure"
            ...
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor != '' and titlecolor != '' and (swatchcolor != titlecolor) :
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"
            ...
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"
    elif wmspcolor == ''  and prodetcolor != '' and swatchcolor != '' and titlecolor != '' and (prodetcolor != swatchcolor)and (prodetcolor != titlecolor) and (swatchcolor != titlecolor):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"
    elif wmspcolor != ''  and prodetcolor == '' and swatchcolor != '' and titlecolor != '' and (wmspcolor != swatchcolor)and (wmspcolor != titlecolor) and (swatchcolor != titlecolor):
            matchtype = "Not Sure"
            ...
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"
    elif prodetsize == '' and swatchsize != '' and wmspsize != '' and (wmspsize!= swatchsize):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"
    elif prodetsize != '' and swatchsize != '' and wmspsize != '' and (prodetsize != swatchsize)and (prodetsize != wmspsize)and (wmspsize!= swatchsize):
            matchtype = "Not Sure"
            matchtypecomments = "Multiple info"

    return matchtype,matchtypecomments

def electronicscellphonematchtype(prodetnetwork,wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel,wmspportno):
    matchtype = ""
    matchtypecomments = ""

    if prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color/Size/Network"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Network"
    elif prodetnetwork != '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color/Size"
    elif prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Size/Network"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color/Network"
    elif prodetnetwork != '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Size"
    elif prodetnetwork != '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color"
    elif prodetnetwork != '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size"
    elif prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Network"
    elif prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Size"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Color"
    elif prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network"
    elif prodetnetwork != '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color"
    elif prodetnetwork != '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and (wmspmodel  != '' or wmsppartno != ''):
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Size/Model"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Size/Model"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor != '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Color/Model"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  != '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Color/Model"
    elif prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  != '' and wmspmodel  == '' and wmsppartno == '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Color/Size"
    
    elif  wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize != '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network/Color/Model"
        ...
        matchtypecomments = "Multiple info"
    return matchtype,matchtypecomments
def electronicswearabletechnologymatchtype(wmos,prodetos,prodetnetwork,wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel):
    matchtype = ""
    matchtypecomments = ""
    ...
    if wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size/Model"
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Color/Network Type"
    
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel != '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Network Type"
        
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Network Type"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type"
    
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Model"
    elif (wmos != '' or prodetos != '') and prodetnetwork == '' and (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and wmspmodel != '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type"
    
        
    elif wmos != '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Color/Size/Model"
    elif wmos == '' and prodetos != '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Network Type/Color/Size/Model"
    elif wmos != '' and prodetos != '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Color/Size/Model"


    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor != '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Size/Model"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor != '' and swatchcolor == '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Size/Model"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == '' and prodetcolor == '' and swatchcolor != '' and titlecolor == '' and  prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Model"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == ''  and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize != '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Model"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == ''  and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize != '' and wmspmodel == '' :
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size"
    elif wmos == '' and prodetos == '' and prodetnetwork == '' and wmspcolor == ''  and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and wmspmodel == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - OS/Network Type/Color/Size/Model"
    elif wmos != '' and prodetos != '' and (wmos != prodetos):
...
def electronicscameramatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,prodetresolution):
    matchtype = ""
    matchtypecomments = ""

    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetresolution == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Resolution"
    elif (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetresolution == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Resolution"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetresolution == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Resolution"
    elif (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetresolution == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Resolution"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetresolution != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size"
...
def electronicsgpsmatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,prodetvolts,prodetitemtype,wmspmodel):
    matchtype = ""
    matchtypecomments = ""

    if wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Volts/Type/Model"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Volts/Type/Model"
    elif  wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Volts/Type/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts != '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Type/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype != '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Volts/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size/Volts/Type"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts == '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Volts/Type/Model"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts != '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Type/Model"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype != '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Volts/Model"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Volts/Type"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts != '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Type/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts == '' and prodetitemtype != '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Volts/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts == '' and prodetitemtype == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Volts/Type"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts != '' and prodetitemtype == '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Type/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts != '' and prodetitemtype != '' and wmspmodel != '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Volts"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts != '' and prodetitemtype == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Type"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize == '' or swatchsize == '' or wmspsize == '') and prodetvolts != '' and prodetitemtype != '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Model"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts == '' and prodetitemtype != '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Volts"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts != '' and prodetitemtype == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Type"
    elif (wmspcolor == '' or prodetcolor == '' or swatchcolor == '' or titlecolor == '') and prodetsize == '' and swatchsize == '' and wmspsize == '' and prodetvolts != '' and prodetitemtype != '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size/Model"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetvolts != '' and prodetitemtype != '' and wmspmodel != '':
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Volts"
    elif (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetvolts != '' and prodetitemtype == '' and wmspmodel != '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Type"
    elif (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize != '' or wmspsize != '') and prodetvolts != '' and prodetitemtype != '' and wmspmodel == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model"
...
def electronicstvmatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel,wmsppartno,wmscreensize):
    matchtype = ""
    matchtypecomments = ""
    
    if wmspsize == '' and wmscreensize != '':
        wmspsize = wmscreensize

    if  wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color/Size"
    elif  wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size"
    elif wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '' :
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color/Size"
    elif  (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Size"
    elif  wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model/Color"
    elif (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        ...
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color/Size"
    elif  (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and wmspmodel  == '' and wmsppartno == '':
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Model"
    elif  (wmspcolor != '' or prodetcolor != '' or swatchcolor != '' or titlecolor != '') and prodetsize == '' and swatchsize  == '' and wmspsize  == '' and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Size"
    elif  wmspcolor == '' and prodetcolor == '' and swatchcolor == '' and titlecolor == '' and (prodetsize != '' or swatchsize  != '' or wmspsize  != '') and (wmspmodel  != '' or wmsppartno != ''):
        matchtype = "Not Sure"
        matchtypecomments = "Info Missing - Color"
...
def AttributeExtraction(lines):
        ...
        if pgproblem == '' or pgproblem == 'Walmart Exclusive':
            try:
                #Brand
            ...
            # Match Type
            if breadcrumbsplit[0] == "Books":
                matchtype,matchtypecomments = bookmatchtype(wmspISBN13,wmspISBN10,titleISBN13,titleISBN10,prodetailISBN13,prodetailISBN10,wmspcolor,wmpagecount,prodetformat,titleformat,wmspformat,swatchformat)
            elif breadcrumbsplit[0] == "Movies & TV Shows" or breadcrumbsplit[0] == "Music":
                matchtype,matchtypecomments = moviesandmusicmatchtype(wmperformer,wmactors,wmdirector,wmspformat,prodetformat,titleformat,wmpmediaformat)
            elif breadcrumbsplit[0] == "Auto & Tires" and breadcrumbsplit[1] == "Tires & Accessories":
               matchtype,matchtypecomments = autotiresmatchtype(wmspmodel,wmsppartno,wmtiresize,prodettiresize,prodetloadrange,titletiresize,titleloadrange,wmtirespeedrating)
            elif breadcrumbsplit[0] == "Video Games":
                matchtype,matchtypecomments = videogamesmatchtype(wmvideogameplatform,titleplatform,prodetplatform,breadcrumb)
            elif (breadcrumbsplit[0] == "Electronics" and "Audio" in breadcrumbsplit or breadcrumbsplit[0] == "Audio") or (breadcrumbsplit[0] == "Electronics" and "Portable Audio" in breadcrumbsplit) or (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Home Audio & Theater") or (breadcrumbsplit[0] == "Portable Audio"):
                matchtype,matchtypecomments = electronicsaudiomatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel)
            elif breadcrumbsplit[0] == "Electronics" and "Computers" in breadcrumbsplit or breadcrumbsplit[0] == "Computers":
                matchtype,matchtypecomments = electronicscomputersmatchtype(wmos,prodetos,prodetnetwork,wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel,wmprocessortype)
            elif breadcrumbsplit[0] == "Cell Phones" or (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Home Theater") or (breadcrumbsplit[0] == "Electronics" and "iPad & Tablets" in breadcrumbsplit) or (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Video") or (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Electronics Accessories"):
                matchtype,matchtypecomments = electronicscellphonematchtype(prodetnetwork,wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel,wmsppartno)
            elif breadcrumbsplit[0] == "Electronics" and "Wearable Technology" in breadcrumbsplit:
                matchtype,matchtypecomments = electronicswearabletechnologymatchtype(wmos,prodetos,prodetnetwork,wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel)
            elif (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Cameras & Camcorders") or (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Drones") or (breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "Surveillance Equipment"):
                matchtype,matchtypecomments = electronicscameramatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,prodetresolution)
            elif breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "GPS & Navigation":
                matchtype,matchtypecomments = electronicsgpsmatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,prodetvolts,prodetitemtype,wmspmodel)
            elif breadcrumbsplit[0] == "Electronics" and breadcrumbsplit[1] == "TV & Home Theater":
                matchtype,matchtypecomments = electronicstvmatchtype(wmspcolor,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,wmspsize,wmspmodel,wmsppartno,wmscreensize)
            elif breadcrumbsplit[0] == "Electronics":
                matchtype,matchtypecomments = electronicsmatchtype(wmos,prodetos,prodetvolts,prodetnetwork)
...
if record != 0:
    ...
    for url_lines in cursor.fetchall():
        pgproblem, matchtype, matchtypecomments, itemid, breadcrumb, wmtitbrand, wmtitle, wmprice, wmdes, titleformat, prodetformat, wmspbrand, wmspcolor, wmspformat, wmspmanuf,wmsppartno, wmspmodel, wmsppack, wmspshape, wmcondition, wmpagecount, titleISBN13, titleISBN10,prodetailISBN13, prodetailISBN10, wmspISBN13, wmspISBN10, wmspdimen, wmspgender, wmspsize, upc, swatchdetails,swatchformat, hprice, imageurl, screenshot_path, wmoccasion, wmringstyle, wmgemstonetype, wmstyle, wmcarats, wmgemstonecut, wmkarats, wmfinefashion, wmtheme, wmbirthstone, wmgemstoneshape ,wmcountryorigin, wmfeatures, wmsleevelength, wmneckstyle, wmpattern, wmfabriccontent, wmclothingsize, wmmoviegenre, wmtargetaudience, wmedition, wmactors, wmduration, wmstudioproductioncompany, wmcharacter, wmdirector, wmreleasedate, wmsptitle, wmlanguage, wmseriestitle, wmtreleasedate, wmpublisher, wmpublicationdate, wmperformer, wmrecordlabel, wmpmediaformat, wmtracklist, wmmusicgenre, wmagegroup, prodetduration, titleepisodes, titleseasons, titlevolumes, prodetepisodes, prodetseasons, prodetvolumes, wmtiresize, wmvehicletype, wmtirewidth, wmwheeldiameter, wmtirespeedrating,wmutqg, wmtiretractionrating,wmtiretreadwearrating,wmtireseason,wmtreaddepth,prodettiresize, prodetloadrange, titletiresize, titleloadrange, sold , wmvideogameplatform,wmgenre,wmvideogamecollection,wmharddrivecapacity,wminternalorextrenal,wmesrbrating,wmiscordless,wmcompatibledevice,wmcompatiblebrands, prodetplatform ,titleplatform, wmprocessortype,wmos,wmprocessorspeed,wmwirelesstech,wmrammemory,wmscreensize,wmprocessorbrand,prodetos,prodetvolts,prodetnetwork,prodetcolor,swatchcolor,titlecolor,prodetsize,swatchsize,prodetresolution,prodetitemtype = AttributeExtraction(url_lines)
