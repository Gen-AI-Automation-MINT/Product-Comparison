...
output_file = 'output_file_id.csv'
output_file_no_duplicates = 'output_file_id_no_duplicates.csv'
...
def remove_duplicate_rows(input_file_withurl, output_removed_duplicates):
    ...
    # Remove duplicate rows from column item_id
    df.drop_duplicates(subset=['item_id'], keep='first', inplace=True)
    # Remove duplicate rows from column retailer_id
